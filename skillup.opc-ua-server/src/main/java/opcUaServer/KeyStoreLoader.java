...
public class KeyStoreLoader {
	...
	KeyStoreLoader load(Path baseDir) throws Exception {
		...
		if (!serverKeyStore.exists()) {
			...
			String applicationUri = "urn:my:server:" + UUID.randomUUID();

			SelfSignedCertificateBuilder builder = new SelfSignedCertificateBuilder(keyPair)
					.setCommonName("OPC UA Server").setOrganization("digitalpetri").setOrganizationalUnit("dev")
					.setLocalityName("Folsom").setStateName("CA").setCountryCode("US")
